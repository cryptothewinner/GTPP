...
export default function CustomersPage() {
    ...
    const { data, isLoading } = useCustomers({ search: searchTerm, role: 'CUSTOMER' });
    ...
    const colDefs: ColDef[] = useMemo(() => [
        ...
        {
            field: 'customerDetails.salesDistrict',
            headerName: 'Bölge',
            width: 120
        },
        {
        ...
        <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden">
            ...
            <header className="bg-white border-b border-slate-200 p-4 px-6 flex items-center justify-between shadow-sm shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="font-bold text-lg text-slate-800">Müşteriler</h1>
                        <p className="text-xs text-slate-500">Müşteri veritabanı ve CRM yönetimi</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col h-full bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                        <div className="flex-1 w-full" style={{ minHeight: '500px' }}>
                            <AgGridReact
                                ...
                                overlayNoRowsTemplate='<span class="ag-overlay-no-rows-center">Müşteri bulunamadı</span>'
                            />
                        </div>
